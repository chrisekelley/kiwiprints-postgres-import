module.exports = {
  ...
  "to_timestamp((doc->'currentPosition' ->>'timestamp')::text::double precision / 1000) AS gps_timestamp,doc->>'gps_name',doc->>'gps_city',doc->>'gps_country',doc->>'deviceUuid',(doc->>'testData')::bool " +
  "FROM couchdocs ",
